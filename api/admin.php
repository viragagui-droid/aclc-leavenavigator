...
/* Top Navbar - Logout sa kanan */
        ...
        .activity-card { background: white; padding: 25px; border-radius: 15px; box-shadow: 0 5px 25px rgba(0,0,0,0.05); }
...
function checkNotif() {
    $.ajax({
        ...
        success: function(data) {
            // Lalabas lang ang alert kung may request na 'is_seen = 0'
            if (data.unseen_count > 0) {
                ...
                Swal.fire({
                    ...
                    toast: true,
                    position: 'top-end',
                    timer: 10000 // Mawawala rin kusa pagkatapos ng 10 secs
                }).then((result) => {
